...
а также вычисляемый столбец category в зависимости от значений unit_price 
...
SELECT 
    ...
    order_id,
    CASE
        WHEN unit_price > 10 THEN 'Expensipe'
        ELSE 'Cheap'
    END
FROM
    order_details;
...
/* 6. Выведите уникальные имена компаний из таблицы customers 
